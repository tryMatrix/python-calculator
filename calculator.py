...
me = Tk()
me.geometry("354x460")
me.title("M.Llogaritëse")
melabel = Label(me, text="Llogaritëse", bg='lightgreen', font=("garamond", 30, 'bold'))
melabel.pack(side=TOP)
me.config(background='cadet blue')
...
butdot = Button(me, padx=40, pady=14, bd=4, bg='aliceblue', command=lambda: clickbut("."), text=". ",
                font=("Courier New", 16, 'bold '))
butdot.place(x=75, y=310)

butpl = Button(me, padx=14, pady=14, bd=4, bg='aliceblue', text="+", command=lambda: clickbut("+"),
               font=("Courier New", 16, 'bold'))
butpl.place(x=205, y=100)

butsub = Button(me, padx=14, pady=14, bd=4, bg='aliceblue', text="-", command=lambda: clickbut("-"),
                font=("Courier New", 16, 'bold'))
butsub.place(x=205, y=170)

butml = Button(me, padx=14, pady=14, bd=4, bg='aliceblue', text="*", command=lambda: clickbut("*"),
               font=("Courier New", 16, 'bold'))
butml.place(x=205, y=240)

butdiv = Button(me, padx=14, pady=14, bd=4, bg='aliceblue', text="/", command=lambda: clickbut("/"),
                font=("Courier New", 16, 'bold'))
butdiv.place(x=205, y=310)

butclear = Button(me, padx=14, pady=119, bd=4, bg='cornsilk', text="C", command=clrbut, font=("Courier New", 16, 'bold'))
butclear.place(x=270, y=100)

butequal = Button(me, padx=144, pady=14, bd=4, bg='cornsilk', command=equlbut, text="=", font=("Courier New", 16, 'bold'))
